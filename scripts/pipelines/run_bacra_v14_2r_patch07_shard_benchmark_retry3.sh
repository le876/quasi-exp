...
OUTPUT_ROOT="$PROJECT_ROOT/runs/bacra_v14_2r_patch07_shard_benchmark_retry3"
...
export MPLCONFIGDIR=/tmp/mpl-bacra-v14-2r-benchmark-retry3
...
"$PYTHON_BIN" "$REPORTER" --config "$CONFIG" --output-root "$OUTPUT_ROOT" --require-pass

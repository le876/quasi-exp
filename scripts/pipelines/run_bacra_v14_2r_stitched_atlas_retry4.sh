...
BENCHMARK_ROOT="$PROJECT_ROOT/runs/bacra_v14_2r_patch07_shard_benchmark_retry3"
OUTPUT_ROOT="$PROJECT_ROOT/runs/bacra_v14_2r_stitched_atlas_retry4"
...
export MPLCONFIGDIR=/tmp/mpl-bacra-v14-2r-retry4

...
CONFIG="$SOURCE_ROOT/configs/bacra_v14_3_repaired_5k_student_v2.yaml"
OUTPUT_ROOT="$PROJECT_ROOT/runs/bacra_v14_3_repaired_5k_student_optimized_v2"
...
export MPLCONFIGDIR=/tmp/mpl-bacra-v14-3-v2

...
CONFIG="$SOURCE_ROOT/configs/bacra_v14_3_retry8_5k.yaml"
OUTPUT_ROOT="$PROJECT_ROOT/runs/bacra_v14_3_retry8_repaired_5k_retry4"

export OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 NUMEXPR_NUM_THREADS=1
export TF_NUM_INTRAOP_THREADS=1 TF_NUM_INTEROP_THREADS=1
export MPLCONFIGDIR=/tmp/mpl-bacra-v14-3-retry8-5k
